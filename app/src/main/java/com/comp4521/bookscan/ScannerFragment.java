...
public class ScannerFragment extends Fragment implements OnClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        if(savedInstanceState != null) {
            long totalInput = savedInstanceState.getLong("bookInfo_totalInput");
            long success = savedInstanceState.getLong("bookInfo_success");
    ...
    private void changeFragment() {
        ...
        //args.putLong("bookInfo_totalInput", os.getTotalInputValue());
        //args.putLong("bookInfo_success", os.getFoundValue());
